...
$sql = "SELECT id, title, abstract, author, datepub, NumberOfCopies FROM library WHERE NumberOfCopies > 0 ORDER BY id ASC LIMIT 15,5";
...
#students th {
  ...
  color: white;
   ...
   <?php } ?>
   <div class="next">
 <a href="collect3.php" class="previous">&laquo; Previous</a>
<a href="collect5.php" class="next">Next &raquo;</a>
