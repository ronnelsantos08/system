...
$sql = "SELECT id, title, abstract, author, datepub, NumberOfCopies FROM library WHERE NumberOfCopies > 0 ORDER BY id ASC LIMIT 5,5";
...
<a href="collect3.php" class="next">Next &raquo;</a>
