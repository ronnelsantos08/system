...
$sql = "SELECT id, title, abstract, author, datepub, NumberOfCopies FROM library WHERE NumberOfCopies > 0 ORDER BY id ASC LIMIT 25,5";
...
<form class="form-inline my-2 my-lg-0" action="bookdelete.php" method="post">
      <input class="form-control mr-sm-2" type="search" placeholder="ID Number" aria-label="Search"name="id">
...
#students th {
  ...
  color: white;
   ...
   <?php } ?>
   <div class="next">
 <a href="collect5.php" class="previous">&laquo; Previous</a>
<a href="collect6.php" class="next">Next &raquo;</a>
