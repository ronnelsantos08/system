...
$sql = "SELECT * FROM `borrow` ORDER BY id ASC LIMIT 0,8";
...
<div id="mainslider" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
     <form class="form-inline my-2 my-lg-0" action="bookstatussearch.php" method="post">
...
#students th {
  ...
  color: white;
        ...
        <table id="students">
            ...
            <tr>
            <th colspan="7">Reserved and Borrowed Books</th></tr>
            <tr>
            <th> ID Number </th>
            <th> Student ID </th>
            <th> Book ID </th>
    ...
    while($row = $result->fetch_assoc()) {
       ...
       <td><a href="statusbookcon.php?id=<?php echo $row['id'];?>&studentid=<?php echo $row['StudentID'];?>&bookid=<?php echo $row['BookID'];?>">Returned</a>
       </td><td><a href="statusbookupdatecon.php?id=<?php echo $row['id'];?>&status=Borrowed">Borrowed</a>
        </td>
   ...
   <?php } ?>
    ...
    <div class="next">
 <a href="studentsbook.php" class="previous">&laquo; Previous</a>
<a href="studentsbook2.php" class="next">Next &raquo;</a>
