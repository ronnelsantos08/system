...
$pdo_search = $pdo_conn->prepare("SELECT * FROM borrow WHERE StudentID LIKE '%$search_keyword%' OR BookID LIKE '%$search_keyword%' OR id LIKE '%$search_keyword%' ORDER BY rand() limit 10");
