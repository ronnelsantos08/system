...
$sql = "SELECT * FROM `borrow` ORDER BY id ASC LIMIT 8,8";
...
#students th {
  ...
  color: white;
    ...
    while($row = $result->fetch_assoc()) {
       ...
       <td><a href="statusbookcon.php?id=<?php echo $row['id'];?>">Returned</a>
       </td><td><a href="statusbookcon.php?id=<?php echo $row['id'];?>">Borrowed</a>
        </td>
