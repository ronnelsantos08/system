...
$sql = "SELECT id, title, abstract, author, datepub, NumberOfCopies FROM library ORDER BY id asc LIMIT 20,5";
...
#students th {
  ...
  font-size: 12px;
   ...
   <?php } ?>
    ...
    <div class="next">
 <a href="admincollect4.php" class="previous">&laquo; Previous</a>
