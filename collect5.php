...
$sql = "SELECT id, title, abstract, author, datepub, NumberOfCopies FROM library WHERE NumberOfCopies > 0 ORDER BY id ASC LIMIT 20,5";
...
#students th {
  ...
  color: white;
   ...
   <?php } ?>
   <div class="next">
 <a href="collect4.php" class="previous">&laquo; Previous</a>
